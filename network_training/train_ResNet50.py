...
from utils_regressor_focal_dist import RotNetDataGenerator, CustomModelCheckpoint
import numpy as np
import glob
...
phi_model = ResNet50(weights='imagenet', include_top=False, input_tensor=main_input, input_shape=input_shape)
...
adam = tf.keras.optimizers.SGD(lr=learning_rate)
